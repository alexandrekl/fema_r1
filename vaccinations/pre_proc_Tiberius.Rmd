...
```{r}
load("~/git-repos/FEMA/vaccinations/app.RData")
...
```{r}
latest_history_date <- as.Date( '2021-03-05' )
...
ggplot(dp) +
    geom_col( data=tmp, aes(x=location, y=distrib, fill=l ), linetype='dashed', size=1, colour='#3399FF' ) +
    scale_fill_manual( name=NULL, values=c('#66CCFF') ) +
    ggpattern::geom_col_pattern( aes(x=shipping_acl_awardee, y=in_transit_total, pattern=l), fill='#66CCFF', pattern_fill='#66CCFF', colour='#3399FF', pattern_spacing=0.02 ) + 
