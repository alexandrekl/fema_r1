...
ggplot( vxordd, aes(x=first_delivery_date, y=day_deliv_avg, color=vax_manufacturer) ) +
            facet_wrap(~ shipping_acl_awardee, ncol=3, scales='free_y' ) +
            geom_point() +
            scale_x_date( name=NULL, limits=c(as.Date('2021-02-15'),as.Date('2021-04-15')), date_labels = '%b%e' ) +
...
dlabels = seq(as.Date("2021-01-11"), as.Date("2021-04-12"), "2 weeks")
...
ggplot(vxordw, aes(fill=vax_manufacturer, y=ft_deliv_ratio, x=ft)) + 
    ...
    scale_x_date( name=NULL, limits=c(as.Date('2021-02-12'),as.Date('2021-04-15')), breaks=dlabels, date_labels = '%b%e' ) + 
